...
components[filters]='esg-access-logging-filter esg-drs-resolving-filter esg-security-las-ip-filter esg-security-tokenless-filters commons-httpclient-3.1.jar commons-lang-2.6.jar esg-security-tokenless-thredds-filters.xml jdom-legacy-1.1.3.jar esg-security-las-ip-filter.xml esapi-2.1.0.1.jar joda-time-2.2.jar not-yet-commons-ssl-0.3.9.jar opensaml-2.6.6.jar openws-1.5.6.jar slf4j-api-1.7.6.jar xmlsec-1.5.7.jar xmltooling-1.4.6.jar tds-extrajars.txt'
