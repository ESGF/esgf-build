...
def create_local_mirror_directory(active_branch, starting_directory, build_list):
    ...
    components["esg-search"] = ['bin/esg-search', 'bin/esgf-crawl', 'bin/esgf-optimize-index', 'etc/conf/jetty/jetty.xml-auth', 'etc/conf/jetty/realm.properties', 'etc/conf/solr/solrconfig.xml', 'etc/conf/solr/solrconfig.xml-replica', 'etc/conf/solr/solr.xml-master', 'etc/conf/solr/solr.xml-slave', 'etc/conf/jetty/webdefault.xml-auth', 'INSTALL', 'README', 'LICENSE']
